	...
	_In_ int       nCmdShow)
{
	...
	ShaderD3D11 volFogFroxelPropertyCS(device, ShaderType::COMPUTE_SHADER, L"VolumetricFoxFroxelAccumulation.cso");
	...
	SetupFroxelVolFog(device, &volFogCamDataCB, &mainCamera, totalSpotLights, froxelTexture);
